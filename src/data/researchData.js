export const researchData = {
  claireundgeorge: {
    opportunitiesForImprovement: [
      {
        id: 'CG_OP1',
        title: 'Virtual Room Tours of Accommodations',
        description: 'Provide immersive 360° views or video walk-throughs of rooms and facilities.',
        interviews: ['CG_INT1', 'CG_INT3'],
        businessAspect: 'Transparency & Trust',
        keyTheme: 'Visual Verification Needs'
      },
      {
        id: 'CG_OP2',
        title: 'AI-Powered Chat Advisor for Detailed Planning',
        description: 'An intelligent chat assistant trained on accessibility nuances to answer specific user queries.',
        interviews: ['CG_INT1', 'CG_INT2'],
        businessAspect: 'Personalized Support',
        keyTheme: 'Personalized Query Capabilities'
      },
      {
        id: 'CG_OP3',
        title: 'Standardized Accessibility Ratings & Detailed Filters',
        description: 'Implement a consistent rating system and highly granular filters for specific accessibility needs.',
        interviews: ['CG_INT1', 'CG_INT3'],
        businessAspect: 'Information Consistency',
        keyTheme: 'Standardization & Detail'
      },
      {
        id: 'CG_OP4',
        title: 'Centralized Information Portal with Verified Data',
        description: 'A single, reliable source for accessibility information, verified by the platform or community.',
        interviews: ['CG_INT1'],
        businessAspect: 'Data Reliability',
        keyTheme: 'Trustworthy Information'
      },
      {
        id: 'CG_OP5',
        title: 'Community-Sourced Ratings & Lived Experiences',
        description: 'Allow users to share their own accessibility ratings, reviews, and photos.',
        interviews: ['CG_INT1'],
        businessAspect: 'Community & Peer Validation',
        keyTheme: 'Lived Experience Sharing'
      },
      {
        id: 'CG_OP6',
        title: 'User-Tested/Verified Certifications for Listings',
        description: 'Introduce a certification or badge for listings that have been physically tested and verified by accessibility experts or trained users.',
        interviews: ['CG_INT3'],
        businessAspect: 'Verification & Assurance',
        keyTheme: 'Trust & Verification'
      },
      {
        id: 'CG_OP7',
        title: 'Personalized Profiles for Specific Access Needs',
        description: 'Allow users to save their accessibility requirements in a profile to automatically filter and highlight suitable accommodations.',
        interviews: ['CG_INT2'],
        businessAspect: 'Personalization & Efficiency',
        keyTheme: 'Personalized Filtering'
      }
    ],
    keyThemes: [
      {
        id: 'CG_KT1',
        name: 'Lack of Consistent & Trustworthy Information',
        quote: 'The lack of consistent, trustworthy accessibility information. Every site uses different terms, and there\'s no standard. Even photos often leave out the bathroom—which is the most critical part.',
        attribution: 'Participant P, Interview 1',
        description: 'Users struggle with inconsistent and unreliable accessibility details across various platforms, making trip planning difficult and stressful.'
      },
      {
        id: 'CG_KT2',
        name: 'Uncertainty and the Need for Visual Verification',
        quote: 'Honestly? The virtual tours. I can tell within seconds if a room works for me just by seeing it. Photos can be misleading. If I had a 360° view or even a walk-through video, I could skip so many calls and emails.',
        attribution: 'Participant P, Interview 1 (Echoed by Jane M.)',
        description: 'Visual confirmation through virtual tours or detailed, unedited photos is highly valued to reduce uncertainty and verify suitability.'
      },
      {
        id: 'CG_KT3',
        name: 'Desire for Personalized & Detailed Query Capabilities',
        quote: 'I\'d say the AI assistant, actually. Ratings are great, but they still rely on someone else\'s idea of what matters. I want to ask my questions—like, "Is there space to transfer on the left side of the bed?"—and get tailored answers.',
        attribution: 'Sarah (39, London), Interview 2',
        description: 'Users want to ask specific, nuanced questions about accessibility features and receive tailored, reliable answers.'
      }
    ],
    businessAspects: [
      {
        id: 'CG_BA1',
        name: 'Develop a verification system for accessibility information.',
        description: 'Builds trust and reduces the primary pain point of unreliable data. This can be a key differentiator, moving beyond self-reported claims to Claire & George verified standards.'
      },
      {
        id: 'CG_BA2',
        name: 'Invest in rich media content like virtual tours and detailed, measured floor plans.',
        description: 'Directly addresses the need for visual confirmation, reducing user effort and anxiety. This can significantly shorten the decision-making process and improve conversion.'
      },
      {
        id: 'CG_BA3',
        name: 'Implement highly detailed and customizable search filters and user profiles.',
        description: 'Allows users to define their specific needs once and receive relevant results, reducing repetitive questioning and frustration. This enhances personalization and user satisfaction.'
      },
      {
        id: 'CG_BA4',
        name: 'Explore AI capabilities for answering specific, nuanced accessibility questions.',
        description: 'Offers a scalable way to provide personalized support, addressing the long tail of individual needs that standardized information might miss. Requires robust training on accessibility nuances.'
      }
    ],
    interviews: [
      {
        id: 'CG_INT1',
        title: 'Interview: Participant P (Muscular Dystrophy)',
        date: 'Summer 2024 (Assumed)',
        summary: 'Participant P, who uses a power wheelchair, details the exhaustive research process for a trip to Barcelona, highlighting the critical lack of consistent, trustworthy accessibility information and the value of visual verification like YouTube tours. Suggests virtual tours and a centralized, verified information portal.',
        fullTranscript: `
...
`
      ...
      {
        id: 'CG_INT2',
        title: 'Interview: Sarah (39, London, Multiple Sclerosis)',
        date: 'Summer 2024 (Assumed)',
        summary: 'Sarah, who has MS and varying mobility, describes the exhausting process of cross-referencing reviews and directly contacting properties. She emphasizes the uncertainty caused by inconsistent accessibility language and values personalized query capabilities (AI assistant) and visual verification (virtual tours).',
        fullTranscript: `
...
`
      ...
      {
        id: 'CG_INT3',
        title: 'Interview: Jane M. (Multiple Sclerosis)',
        date: 'April 10, 2025',
        summary: 'Jane M., a power wheelchair user, emphasizes the need for standardization in accessibility terms and the value of peer validation. She booked her last trip via phone after a manager provided a video walkthrough. She prioritizes virtual tours and suggests user-verified certifications.',
        fullTranscript: `
Participant: Jane M.
...
`
  ...
  rugennek: {
    opportunitiesForImprovement: [
      {
        id: 'R_OP1',
        title: 'Develop a Comprehensive Digital Patient Portal',
        description: 'An app or web portal for appointment management (scheduling, rescheduling), viewing personalized treatment plans and progress notes, accessing prescribed exercises with video guides, and secure messaging with clinic staff.',
        interviews: ['R_INT1', 'R_INT2', 'R_INT3'],
        businessAspect: 'Clinic Operations & Technology',
        keyTheme: 'Modernization of Patient Experience'
      },
      {
        id: 'R_OP2',
        title: 'Standardize and Enhance Intake & Treatment Plan Communication',
        description: 'Create clear, visual, and upfront explanations of what to expect during the initial intake, the proposed treatment plan (including frequency and expected duration), and transparent pricing/package options. This could include a printable or digital "treatment roadmap."',
        interviews: ['R_INT1', 'R_INT2', 'R_INT3'],
        businessAspect: 'Patient Onboarding & Communication',
        keyTheme: 'Clarity and Transparency'
      },
      {
        id: 'R_OP3',
        title: 'Implement a "Whole Person" Care Training Module for Staff',
        description: 'Training for all staff (receptionists, chiropractors) focusing on active listening, demonstrating empathy, and addressing patient anxieties or concerns that go beyond purely physical symptoms, fostering a stronger human connection and sense of being cared for.',
        interviews: ['R_INT1', 'R_INT3'],
        businessAspect: 'Treatment Process & Personalization',
        keyTheme: 'Personalized Care and Human Connection'
      }
    ],
    keyThemes: [
      { id: 'R_KT1', name: 'Clarity and Transparency', description: 'Patients desire clearer information about intake procedures, treatment plans, timelines, and pricing to set better expectations.' },
      { id: 'R_KT2', name: 'Personalized Care and Human Connection', description: 'Patients value feeling heard, understood, and treated as individuals, with care that acknowledges their emotional and overall well-being.' },
      { id: 'R_KT3', name: 'Modernization of Patient Experience', description: 'Suggestions for digital tools like online portals/apps for improved scheduling, progress tracking, and communication.' }
    ],
    businessAspects: [
      { id: 'R_BA1', name: 'Patient Onboarding & Communication', description: 'Focuses on the initial interactions, information provided regarding treatment plans and costs, and ongoing communication channels.' },
      { id: 'R_BA2', name: 'Treatment Process & Personalization', description: 'Relates to the actual chiropractic care, how it is tailored to individual needs, and how patient progress is managed and communicated.' },
      { id: 'R_BA3', name: 'Clinic Operations & Technology', description: 'Covers aspects like appointment scheduling, billing processes, and the use of technology to enhance overall patient experience and clinic efficiency.' }
    ],
    interviews: [
      {
        id: 'R_INT1',
        title: 'Interview with Laura (Den Haag Clinic)',
        date: 'Unknown',
        summary: "Laura had a very positive experience, highlighting the smooth intake, clear explanations from Dr. van Dijk, and personalized care. She felt genuinely cared for, especially when her emotional state was acknowledged. Suggestions: clearer 'end goal' for treatment timeline and digitizing the redundant paper intake form. Recommends the clinic for its professionalism and care.",
        fullTranscript: "Laura had a very positive experience, highlighting the smooth intake, clear explanations from Dr. van Dijk, and personalized care. She felt genuinely cared for, especially when her emotional state was acknowledged. Suggestions: clearer 'end goal' for treatment timeline and digitizing the redundant paper intake form. Recommends the clinic for its professionalism and care."
      },
      {
        id: 'R_INT2',
        title: 'Interview with Software Developer (Utrecht Clinic)',
        date: 'Unknown',
        summary: "This participant, initially skeptical, was impressed by the smooth online booking, welcoming atmosphere (offered tea), and Lotte, the chiropractor. The clear 6-week plan and personalized exercises made them feel in control. A memorable moment was the clinic's flexibility when they were late. Suggestions: clarify intake vs. treatment in booking, improve invoice details, and add a progress tracker in an app/video for intake expectations. Highly recommends.",
        fullTranscript: "This participant, initially skeptical, was impressed by the smooth online booking, welcoming atmosphere (offered tea), and Lotte, the chiropractor. The clear 6-week plan and personalized exercises made them feel in control. A memorable moment was the clinic's flexibility when they were late. Suggestions: clarify intake vs. treatment in booking, improve invoice details, and add a progress tracker in an app/video for intake expectations. Highly recommends."
      },
      {
        id: 'R_INT3',
        title: 'Interview with Marloes (Utrecht Clinic)',
        date: 'Unknown',
        summary: "Marloes found online booking smooth but was unclear about the intake appointment's nature and treatment frequency/cost upfront. She appreciated the chiropractor's explanations and personalized care, especially a moment where her anxiety was acknowledged. Suggestions: more upfront transparency on treatment plans/costs, a patient portal/app for managing appointments and notes, and better consistency/handover between different chiropractors. Frustrated by 'salesy' package pricing. Recommends for care quality but advises advocating for needs.",
        fullTranscript: "Marloes found online booking smooth but was unclear about the intake appointment's nature and treatment frequency/cost upfront. She appreciated the chiropractor's explanations and personalized care, especially a moment where her anxiety was acknowledged. Suggestions: more upfront transparency on treatment plans/costs, a patient portal/app for managing appointments and notes, and better consistency/handover between different chiropractors. Frustrated by 'salesy' package pricing. Recommends for care quality but advises advocating for needs."
      }
    ]
  }
}; 